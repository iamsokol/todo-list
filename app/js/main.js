...
let localItemsList = JSON.parse(localStorage.getItem("itemsList")),
itemsList = localItemsList ? localItemsList : [];
...
const renderList = () => {
  ...
  const removeButtons = document.querySelectorAll('.js-item-delete'),
  ...
  let storedNames = JSON.parse(localStorage.getItem("itemsList"));
